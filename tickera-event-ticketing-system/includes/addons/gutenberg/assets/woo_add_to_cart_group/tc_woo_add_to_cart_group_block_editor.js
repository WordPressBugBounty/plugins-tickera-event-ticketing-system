...
registerBlockType( 'tickera/woo-add-to-cart-group', {
    ...
    description: __( 'Woo Ticket Add to Cart button', 'tickera-event-ticketing-system' ),
    icon: 'cart',
    category: 'widgets',
    keywords: [
        ...
        __( 'WooCommerce', 'tickera-event-ticketing-system' )
    ],
    supports: { html: false },
    attributes: {
        id: {
        ...
        return [
            el (
                ...
                el(
                    SelectControl,
                    {
                        label: __( 'Ticket Type (Product)', 'tickera-event-ticketing-system' ),
