    ...
    <div class="tc-wiz-screen-wrap tc-license-key <?php echo esc_attr( tickera_wizard_wrapper_class() ); ?>">
        ...
        <div class="tc-wiz-screen">
            ...
            <div class="tc-wiz-screen-content">
                ...
                <?php $tickera_general_settings = get_option( 'tickera_general_setting', false ); ?>
                <input type="text" placeholder="<?php esc_attr_e( 'License Key', 'tickera-event-ticketing-system' ); ?>" name="tc-license-key" id="tc-license-key" value="<?php echo esc_attr( isset( $tickera_general_settings[ 'license_key' ] ) ? $tickera_general_settings[ 'license_key' ] : '' ); ?>"/>
