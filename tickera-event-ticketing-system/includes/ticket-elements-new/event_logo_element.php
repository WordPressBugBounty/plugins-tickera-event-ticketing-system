...
if ( ! class_exists( '\Tickera\Ticket\Element\tc_event_logo_element' ) ) {
    ...
    class tc_event_logo_element extends TC_Ticket_Template_Elements {
        ...
        function on_creation() {
            $this->element_title = tickera_apply_filters( 'tickera_event_logo_element_title', __( 'Event Logo', 'tickera-event-ticketing-system' ) );
        }
        ...
        function ticket_content( $ticket_instance_id = false, $ticket_type_id = false ) {
            ...
            if ( $ticket_instance_id ) {
                ...
                $event_logo = tickera_apply_filters( 'tickera_event_logo_element', get_post_meta( $event_id, 'event_logo_file_url', true ) );
                ...
                if ( $ticket_type_id ) {
                    ...
                    return '<br/>' . tickera_apply_filters( 'tickera_event_logo_element', '<img src="' . esc_url( $event->details->event_logo_file_url ) . '" />' );

                } else {
                    return '<br/>' . tickera_apply_filters( 'tickera_event_logo_element_default', '<img src="' . esc_url( $tc->plugin_dir . 'images/tickera_logo.png' ) . '" />' );
                }
            }
        }
    }
