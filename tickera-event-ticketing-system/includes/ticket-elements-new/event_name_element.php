...
if ( ! class_exists( '\Tickera\Ticket\Element\tc_event_name_element' ) ) {
    ...
    class tc_event_name_element extends TC_Ticket_Template_Elements {
        ...
        function on_creation() {
            $this->element_title = tickera_apply_filters( 'tickera_event_name_element_title', __( 'Event Name', 'tickera-event-ticketing-system' ) );
        }
        ...
        function ticket_content( $ticket_instance_id = false, $ticket_type_id = false ) {
            ...
            if ( $ticket_instance_id ) {
                ...
                return '<br/>' . tickera_apply_filters( 'tickera_event_name_element', $event_name );
                ...
                if ( $ticket_type_id ) {
                    ...
                    $event = new \Tickera\TC_Event( $event_id );
                    return '<br/>' . tickera_apply_filters( 'tickera_event_name', $event->details->post_title );

                } else {
                    return '<br/>' . tickera_apply_filters( 'tickera_event_name_element', esc_html__( 'Great Event', 'tickera-event-ticketing-system' ) );
                }
            }
        }
    }
