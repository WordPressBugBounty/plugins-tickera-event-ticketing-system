...
if ( ! class_exists( '\Tickera\Ticket\Element\tc_sponsors_logos_element' ) ) {
    ...
    class tc_sponsors_logos_element extends TC_Ticket_Template_Elements {
        ...
        function on_creation() {
            $this->element_title = tickera_apply_filters( 'tickera_sponsors_logos_element_title', __( 'Sponsors Logos', 'tickera-event-ticketing-system' ) );
        }
        ...
        function ticket_content( $ticket_instance_id = false, $ticket_type_id = false ) {
            ...
            if ( $ticket_instance_id ) {
                ...
                $sponsors_logo = tickera_apply_filters( 'tickera_sponsors_logos_element', get_post_meta( $event_id, 'sponsors_logo_file_url', true ) );
                ...
                if ( $ticket_type_id ) {
                    ...
                    return '<br/>' . wp_kses_post( tickera_apply_filters( 'tickera_sponsors_logos_element', '<img src="' . esc_url( $event->details->sponsors_logo_file_url ) . '" />' ) );

                } else {
                    return '<br/>' . wp_kses_post( tickera_apply_filters( 'tickera_sponsors_logos_element_default', esc_html__( 'Sponsor Logos', 'tickera-event-ticketing-system' ) ) );
                }
            }
        }
    }
