...
if ( ! class_exists( '\Tickera\Ticket\Element\tc_ticket_owner_name_element' ) ) {
    ...
    class tc_ticket_owner_name_element extends TC_Ticket_Template_Elements {
        ...
        function on_creation() {
            $this->element_title = tickera_apply_filters( 'tickera_ticket_owner_name_element_title', __( 'Ticket Owner Name', 'tickera-event-ticketing-system' ) );
        }
        ...
        function ticket_content( $ticket_instance_id = false, $ticket_type_id = false ) {
            ...
            if ( $ticket_instance_id ) {
                ...
                return '<br/>' . tickera_apply_filters( 'tickera_ticket_owner_name_element', $owner_name );

            } else {
                return '<br/>' . tickera_apply_filters( 'tickera_ticket_owner_name_element_default', __( 'John Smith', 'tickera-event-ticketing-system' ) );
            }
        }
    }
