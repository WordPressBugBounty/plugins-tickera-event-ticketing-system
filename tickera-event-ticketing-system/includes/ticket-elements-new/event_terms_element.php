...
if ( ! class_exists( '\Tickera\Ticket\Element\tc_event_terms_element' ) ) {
    ...
    class tc_event_terms_element extends TC_Ticket_Template_Elements {
        ...
        function on_creation() {
            $this->element_title = apply_filters( 'tc_event_terms_element_title', __( 'Terms & Conditions', 'tickera-event-ticketing-system' ) );
        }
        ...
        function ticket_content( $ticket_instance_id = false, $ticket_type_id = false ) {
            ...
            if ( $ticket_instance_id ) {
                ...
                return '<br/>' . apply_filters( 'tc_event_terms_element', $event_terms );
