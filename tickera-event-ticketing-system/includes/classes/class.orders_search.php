    ...
    class TC_Orders_Search {
        ...
        function get_results( $count = false ) {
            ...
            if ( $this->search_term !== '' ) {
                ...
                if ( $this->post_status !== 'any' ) {
                    $post_status_query = "AND $wpdb->posts.post_status = '" . sanitize_text_field( $this->post_status ) . "' ";
                } else {
                    $post_status_query = '';
                }
        ...
        function get_count_of_all() {
            ...
            $args = array_merge( $args, [
                ...
                'post_mime_type' => '',
                'post_parent' => '',
                'post_status' => isset( $_GET[ 'post_status' ] ) ? sanitize_key( $_GET[ 'post_status' ] ) : 'any'
            ] );
        ...
        function page_links() {
            $current_post_status = isset( $_GET[ 'post_status' ] ) ? sanitize_key( $_GET[ 'post_status' ] ) : 'any';
