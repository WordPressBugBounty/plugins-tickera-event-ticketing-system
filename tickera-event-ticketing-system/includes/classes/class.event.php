...
if ( ! class_exists( '\Tickera\TC_Event' ) ) {
    ...
    class TC_Event {
        ...
        /**
         * Collection of Event's ticket type ids
         *
         ...
         * @return array
         *
         * Show/hide ticket seat type
         * @param bool $show_seats
         * @since 3.5.1.8
         */
        function get_event_ticket_types( $post_status = 'any', $event_id = false, $show_variations = true, $show_seats = true ) {
            ...
            if ( ! $show_seats ) {
                $args[ 'meta_query' ][] = [
                    ...
                    [ 'key' => '_tc_used_for_seatings', 'value' => 'no', 'compare' => '=' ]
                ];
            }
        ...
        function get_event_date( $event_id = false, $end_date = true ) {
            if ( ! $event_id ) {
                $event_id = $this->id;
            }
